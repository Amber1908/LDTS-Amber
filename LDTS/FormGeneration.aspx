...
<%--                                        <asp:Button ID="Preview" runat="server" Text="瀏覽表單" CssClass="btn btn-default mt-3" OnClientClick="";/>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
...
<asp:Content ID="Content3" ContentPlaceHolderID="jqueryPlaceHolder" runat="server">
    <script>
        ...
        function preview() {
            ...
            let preview ="";
            console.log(previewJsonStr);
            sonWindow.document.body.innerHTML = "<h1>holle</h1>";
        };
            ...
            for (var i = 0; i < Obj.Groups.length; i++) {
                ...
                switch (Obj.Groups[i].GroupType) {//先判斷GroupType
                    case "normal":
                        ...
                        previewStr += "</h3>";
                        previewStr += "</div>";
                        previewStr += "<div class=\"card-body row\">";
